...
class BalusterVC: UIViewController, UITextFieldDelegate {
    ...
    func setupButtonAction() {
        btncalculate.addTarget(self, action: #selector(calculateBalusterConversion), for: .touchUpInside)
    }
